...
using WindowsFormsApp1.CustomHeatmap;
using WindowsFormsApp1.Database;
using WindowsFormsApp1.Device;
...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        Models.ProbeModel prob = new Models.ProbeModel()
        {
            TotalElements = 32,
        ...
        Models.SscanModel scan = new Models.SscanModel()
        {
            StartAngle = -45,
            EndAngle = 45,
            AngleResolution = 1,
        ...
        public Form1()
        {
            ...
            Database.Database.ProbConfigs.Add(new Database.ProbConfig("Probe1"));
            Database.Database.ProbConfigs.Add(new Database.ProbConfig("Probe2"));
            Database.Database.ProbConfigs.Add(new Database.ProbConfig("Probe3"));
            Database.Database.ProbConfigs.Add(new Database.ProbConfig("Probe4"));
        ...
        {
            foreach(ProbConfig pc in Database.Database.ProbConfigs)
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            foreach (ProbConfig pc in Database.Database.ProbConfigs)
            {
                if (pc.Enable == true)
                {
                    ...
                    do
                    {
                        delays.Add(BeamCalc.SearchFocalLaw(pc.Probe, Database.Database.Material, pc.Wedge, angle, pc.FocalLaw.FocusLength));
