...
namespace KSS_Library
{
	...
	public abstract class TabStyleProvider : Component
	{
        ...
        protected TabStyleProvider(KSS_TabControl tabControl)
        {
		...
		public static TabStyleProvider CreateProvider(KSS_TabControl tabControl){
        ...
        protected KSS_TabControl _TabControl;
