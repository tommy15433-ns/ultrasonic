...
namespace Power_Modbus_RTU_SAMPLE
{
    ...
    public class Lucid_Control_AO
    { 
        public SerialPort spCOM;
        private float iLimitSecond;
        LucidControlAO8 lucid;
        ValueVOS2 v;
        IoReturn ret;

        public Lucid_Control_AO(string sPort)
        {
            try
            {
                lucid = new LucidControlAO8(sPort);
        ...
        public void SETAO(double ch, double volt)
        {
